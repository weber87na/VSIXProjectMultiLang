...
namespace VSIXProjectMultiLang
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandMoveToIfBegin
    {
        ...
        private CommandMoveToIfBegin(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CommandMoveToIfBegin Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new CommandMoveToIfBegin( package, commandService );
        }
