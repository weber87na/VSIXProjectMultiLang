...
namespace VSIXProjectMultiLang
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandConvToEng
    {
        ...
        private CommandConvToEng(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CommandConvToEng Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new CommandConvToEng( package, commandService );
        }
