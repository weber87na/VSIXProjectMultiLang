...
namespace VSIXProjectMultiLang
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandToggle
    {
    ...
    private IWpfTextView wpfTextView;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandToggle"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private CommandToggle(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CommandToggle Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in CommandToggle's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync( package.DisposalToken );

            OleMenuCommandService commandService = await package.GetServiceAsync( typeof( IMenuCommandService ) ) as OleMenuCommandService;
            Instance = new CommandToggle( package, commandService );
        }
        ...
        private void Exec()
        {
            ...
            MethodLogic moveMethod = new MethodLogic( );
            moveMethod.Toggle( wpfTextView );
