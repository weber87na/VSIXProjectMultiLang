...
namespace VSIXProjectMultiLang
{
    ...
    /// </summary>
    public struct PostfixCompletionViewContext : ICodeEditor
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostfixCompletionViewContext"/> struct.
        /// </summary>
        ...
        public PostfixCompletionViewContext(IWpfTextView wpfView, IVsTextView textView)
        {
            WpfView = wpfView;
            TextView = textView;
